...
@pytest.fixture
def exchange_interface(fake_exchange_manager, fake_risk_manager, fake_db_queries, fake_logger):
    return ExchangeInterface(fake_exchange_manager, fake_risk_manager, fake_db_queries, fake_logger)
