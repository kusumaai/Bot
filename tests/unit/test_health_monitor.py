...
@pytest.mark.asyncio
async def test_health_monitor_database_check_success(health_monitor_fixture, mock_db_queries):
...
@pytest.mark.asyncio
async def test_health_monitor_database_check_failure(health_monitor_fixture, mock_db_queries):
...
async def test_health_monitor_exchange_check_failure(health_monitor_fixture):
    ...
    health_monitor_fixture.exchange_interface.exchange.ping.side_effect = Exception("Exchange Unreachable")
